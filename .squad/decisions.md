...
### Brand: GitHub Pages Deployment for New Repository (2026-06-01)

**Date:** 2026-06-01T10:42:47.128+02:00  
**Status:** Implemented  
**Owner:** Brand  

**Decision:** Publish the Hugo site through GitHub Actions Pages at `https://hobru.github.io/seb-gak-ki-und-mehr/` while keeping the current `master` branch.

**Rationale:** Holger created the GitHub repository and requested a first GitHub Pages preview before later custom-domain work. The existing Hugo + GitHub Actions Pages architecture already fits this, and the workflow triggers both `main` and `master`, so no branch rename is required.
...
**Verification:** Local validation command: `hugo --minify --baseURL "https://hobru.github.io/seb-gak-ki-und-mehr/"`
