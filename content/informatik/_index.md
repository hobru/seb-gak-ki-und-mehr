...
tool_sections:
  ...
  - id: "deutsch"
    ...
    cards:
      ...
      - title: "Orthografietrainer"
        ...
        links:
          - label: "Orthografietrainer"
            url: "https://orthografietrainer.net/"
      - title: "Projekt Gutenberg-DE"
        desc: "Viele gemeinfreie literarische Texte online – praktisch zum Nachlesen klassischer Werke und für Referate."
        links:
          - label: "Projekt Gutenberg-DE"
  ...
  - id: "englisch"
    ...
    cards:
      ...
      - title: "Cambridge Dictionary"
        desc: "Wörterbuch mit Aussprache, Beispielsätzen und Lernerklärungen – hilfreich beim Schreiben und Übersetzen."
        links:
  ...
  - id: "latein"
    ...
    cards:
      ...
      - title: "PONS Latein-Wörterbuch"
        ...
        links:
          - label: "PONS Latein"
            url: "https://de.pons.com/%C3%BCbersetzung/latein-deutsch"
      - title: "Perseus Digital Library"
        desc: "Umfangreiche Sammlung antiker Texte und Wörterbücher; eher für Fortgeschrittene, aber sehr wertvoll für Quellenarbeit."
        links:
          - label: "Perseus"
  ...
  - id: "geschichte"
    ...
    cards:
      ...
      - title: "Zeitklicks"
        desc: "Schülerfreundliche Darstellungen zur deutschen und europäischen Geschichte des 20. Jahrhunderts."
        links:
          - label: "Zeitklicks"
            url: "https://www.zeitklicks.de/"
      - title: "Planet Wissen Geschichte"
        desc: "Artikel, Videos und Dossiers der öffentlich-rechtlichen Sender – gut für Überblick und Referatsvorbereitung."
        links:
  ...
  - id: "religion-ethik"
    icon: "🧭"
    color: "blue"
    nav_label: "Religion/Ethik"
    title: "Religion & Ethik"
    cards:
      - title: "religionen-entdecken.de"
        desc: "Kind- und jugendgerechte Informationen zu Weltreligionen, Festen, Begriffen und religiösem Alltag."
        links:
  ...
  - id: "chemie"
    ...
    cards:
      ...
      - title: "PhET Chemie-Simulationen"
        ...
        links:
          - label: "PhET Chemie"
            url: "https://phet.colorado.edu/de/simulations/filter?subjects=chemistry&type=html"
      - title: "Chemie.de Grundlagen"
        desc: "Lexikonartige Erklärungen zu chemischen Begriffen; gut zum Nachschlagen, kritisch mit Werbung umgehen."
        links:
          - label: "Chemie.de"
  ...
  - id: "eltern"
    ...
    color: "amber"
    nav_label: "Eltern"
    title: "Für Eltern: Begleiten & einordnen"
    cards:
      - title: "klicksafe"
        desc: "Informationen zu Medienkompetenz, Social Media, Datenschutz, Cybermobbing und Bildschirmzeit – gut für Gespräche zu Hause."
        links:
          - label: "klicksafe"
            url: "https://www.klicksafe.de/"
      - title: "SCHAU HIN!"
        desc: "Alltagsnahe Tipps zur Medienerziehung, Smartphone-Regeln, Games, Streaming und sozialen Netzwerken."
        links:
          - label: "SCHAU HIN!"
            url: "https://www.schau-hin.info/"
      - title: "BSI für Bürgerinnen und Bürger"
        desc: "Praktische Sicherheitsinformationen zu Passwörtern, Updates, Phishing und Schutz digitaler Geräte."
        links:
          - label: "BSI digital sicher"
...
audience_guidance:
  - icon: "🎒"
    ...
    desc: "Nutze die Links zum **Verstehen und Üben**: lieber kleine Einheiten regelmäßig bearbeiten als kurz vor der Klassenarbeit alles auf einmal. Prüfe bei jeder Quelle, ob sie zu deinem Niveau und deiner Aufgabe passt."
  - icon: "🏠"
    title: "Für Eltern"
    desc: "Die Sammlung kann helfen, passende Angebote mit dem eigenen Kind auszuwählen. Besonders sinnvoll sind Seiten, die ohne Konto funktionieren und Fehler erklären statt nur Punkte zu zählen."

responsible_questions:
  - title: "Brauche ich ein Konto?"
    desc: "Wenn eine Übung ohne Anmeldung funktioniert, ist das oft die datensparsamere Wahl. Accounts nur anlegen, wenn der Nutzen klar ist."
  - title: "Wer steckt hinter dem Angebot?"
    desc: "Öffentliche Einrichtungen, Stiftungen, Universitäten und bekannte Bildungsanbieter sind meist leichter einzuordnen als anonyme Lernportale."
  - title: "Passt das Niveau?"
    desc: "Zu leichte Aufgaben langweilen, zu schwere frustrieren. Gute Angebote lassen sich nach Klasse, Thema oder Niveau filtern."
  - title: "Was passiert mit meinen Daten?"
    desc: "Keine Namen, Klassenlisten, Fotos oder privaten Texte hochladen, wenn es nicht nötig ist. Datenschutz- und Cookie-Hinweise ernst nehmen."
  - title: "Hilft es beim Verstehen?"
    desc: "Ein gutes digitales Angebot erklärt Lösungswege, zeigt Beispiele und macht Fehler nachvollziehbar."
  - title: "Ist das Ergebnis überprüfbar?"
    desc: "Gerade bei Referaten und Hausaufgaben immer mit Unterrichtsmaterial, Schulbuch oder weiteren Quellen gegenprüfen."
---

**Diese Seite wird regelmäßig aktualisiert.** Ein Projekt des **Schulelternbeirats des Gymnasiums am Kaiserdom Speyer** – keine offizielle Schulkommunikation. Fragen oder Rückmeldungen? Schreib an den [Schulelternbeirat](https://gak-speyer.de/menschen-am-gak/schulelternbeirat) oder öffne ein GitHub Issue.
